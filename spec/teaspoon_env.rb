...
Teaspoon.configure do |config|
  ...
  config.asset_paths = ['app/assets/javascripts/']
  ...
  config.fixture_paths = ['spec/javascripts/fixtures/json']
  ...
  #    https://github.com/modeset/teaspoon/wiki/Using-BrowserStack-WebDriver
  # Capybara Webkit:
  ...
  config.coverage do |coverage|
    ...
    coverage.reports = ['text-summary', 'html', 'lcovonly']
