describe 'CQL Coverage', ->
  beforeEach ->
    ...
    bonnie.valueSetsByOid = getJSONFixture('cqm_measure_data/special_measures/CMS10/value_sets.json')
    @cqlMeasure = new Thorax.Models.Measure getJSONFixture('cqm_measure_data/special_measures/CMS10/CMS10v0.json'), parse: true
