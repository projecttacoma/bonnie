...
class PatientBuilderTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    @valuesets = {
      "2.16.840.1.113883.3.526.3.1492"=>
        HealthDataStandards::SVS::ValueSet.new({"oid" => "2.16.840.1.113883.3.526.3.1492", "concepts"=>[
      ...
      "2.16.840.1.113883.3.464.1003.102.12.1011"=>
        HealthDataStandards::SVS::ValueSet.new({"oid" => "2.16.840.1.113883.3.464.1003.102.12.1011" , "concepts"=>[
      ...
      "2.16.840.1.113883.3.464.1003.106.12.1005"=>
        HealthDataStandards::SVS::ValueSet.new({"oid" => "2.16.840.1.113883.3.464.1003.106.12.1005", "concepts"=>[
      ...
      "2.16.840.1.113883.3.526.3.1139"=>
        HealthDataStandards::SVS::ValueSet.new({"oid" => "2.16.840.1.113883.3.526.3.1139" , "concepts"=>[
        ...
        HealthDataStandards::SVS::ValueSet.new({"oid" => "2.16.840.1.113883.3.526.3.1259" , "concepts"=>[
          HealthDataStandards::SVS::Concept.new({"code_system_name" => "CPT", "code" =>"CHACHA1"}),
          HealthDataStandards::SVS::Concept.new({"code_system_name" => "CPT", "code" =>"CHACHA2"}),
          HealthDataStandards::SVS::Concept.new({"code_system_name" => "SNOMED", "code" =>"SNO1"}),
          HealthDataStandards::SVS::Concept.new({"code_system_name" => "SNOMED", "code" =>"SNO2"})]
        }),
        "2.16.840.1.113883.3.666.5.1084"=>
        HealthDataStandards::SVS::ValueSet.new({"oid" => "2.16.840.1.113883.3.666.5.1084" , "concepts"=>[
          HealthDataStandards::SVS::Concept.new({"code_system_name" => "CPT", "code" =>"CHACHA1"})]
        })
  ...
  test "derive entry with ID type field value" do
    ...
    entry = Measures::PatientBuilder.derive_entry(med_data_criteria,@source_data_criteria_with_id, @p1_valuesets)
    Measures::PatientBuilder.derive_field_values(entry,@source_data_criteria_with_id["field_values"],@p1_valuesets)
